...
////
//                                   intent.putExtra("forOrderEma", email);
//                                   intent.putExtra("forOrderPh", phone);
//                                   intent.putExtra("forOrderA", address);
//                                   intent.putExtra("forOrderName", name);
//                                   intent.putExtra("forOrderProd_names", prod_names);
//                                   startActivity(intent);


                                   //Sekojosos vajadzes make order pogas nospiesanai jo bez adreses nevar
//                                   if ((userA.getText()).equals("")) {
//                                       Toast.makeText(CheckoutActivity.this, "Please Write down Your Address!", Toast.LENGTH_SHORT).show();
//                                   } else {
//
//                                   }
                               }
